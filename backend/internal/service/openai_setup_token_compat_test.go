...
func TestIsOpenAIOAuthLike(t *testing.T) {
	tests := []struct {
		...
		{name: "openai_api_key", account: &Account{Platform: PlatformOpenAI, Type: AccountTypeAPIKey, Extra: map[string]any{"openai_responses_mode": "force_responses"}}, want: false, codex: false},
