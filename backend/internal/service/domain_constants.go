...
const (
	...
	SettingKeyTicketSystemEnabled   = "ticket_system_enabled"
	SettingKeyTicketRecipientEmails = "ticket_recipient_emails"
	...
	SettingKeyHomeScript                  = "home_script"                   // 自定义首页脚本（管理员填写的浏览器端 JavaScript）
