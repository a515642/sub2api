...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			FirstOutputFailoverEnabled:        apiKey.Group.FirstOutputFailoverEnabled,
			FirstOutputFailoverTimeoutSeconds: apiKey.Group.FirstOutputFailoverTimeoutSeconds,
			FirstOutputFailoverMaxSwitches:    apiKey.Group.FirstOutputFailoverMaxSwitches,
		}
	}
	return snapshot
}
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			FirstOutputFailoverEnabled:        snapshot.Group.FirstOutputFailoverEnabled,
			FirstOutputFailoverTimeoutSeconds: snapshot.Group.FirstOutputFailoverTimeoutSeconds,
			FirstOutputFailoverMaxSwitches:    snapshot.Group.FirstOutputFailoverMaxSwitches,
		}
	}
