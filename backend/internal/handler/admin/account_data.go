...
type DataAccount struct {
	...
	UserBillingRateMultiplier *float64                      `json:"user_billing_rate_multiplier,omitempty"`
	UserBillingModelPricing   []service.ChannelModelPricing `json:"user_billing_model_pricing,omitempty"`
...
func (h *AccountHandler) ExportData(c *gin.Context) {
	...
	for i := range accounts {
		...
		dataAccounts = append(dataAccounts, DataAccount{
			...
			UserBillingRateMultiplier: acc.UserBillingRateMultiplier,
			UserBillingModelPricing:   acc.UserBillingModelPricing,
			ExpiresAt:                 expiresAt,
...
func (h *AccountHandler) importData(ctx context.Context, req DataImportRequest) (DataImportResult, error) {
	...
	for i := range dataPayload.Accounts {
		...
		accountInput := &service.CreateAccountInput{
			...
			UserBillingRateMultiplier: item.UserBillingRateMultiplier,
			UserBillingModelPricing:   item.UserBillingModelPricing,
			GroupIDs:                  nil,
