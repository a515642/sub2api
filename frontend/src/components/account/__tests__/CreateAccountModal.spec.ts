...
describe('CreateAccountModal OpenAI long-context billing', () => {
  ...
  it('persists upstream model metadata after creating an account from preview', async () => {
    ...
    await wrapper.get('[data-testid="account-api-key-input"]').setValue('test-api-key')
  ...
  it('submits OpenCode Zen default protocol rules with adaptive endpoints', async () => {
    ...
    await wrapper.get('form#create-account-form').findAll('textarea')[1].setValue('sk-opencode-zen')
  ...
  it('submits OpenCode GO endpoints after switching account type', async () => {
    ...
    await wrapper.get('form#create-account-form').findAll('textarea')[1].setValue('sk-opencode-go')
  ...
  it('submits adaptive Kimi Coding Plan Responses endpoint', async () => {
    ...
    await wrapper.get('form#create-account-form').findAll('textarea')[1].setValue('sk-kimi-coding')
  ...
  it('submits adaptive MiniMax protocol endpoints', async () => {
    ...
    await wrapper.get('form#create-account-form').findAll('textarea')[1].setValue('sk-minimax')
