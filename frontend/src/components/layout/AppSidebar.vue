    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M2.25 8.25h19.5l-1.5 12H3.75l-1.5-12zM8.25 10.5V6a3.75 3.75 0 017.5 0v4.5'
        })
      ]
    )
}
    ...
    h(
      ...
      [
        h('path', {
          'stroke-linecap': 'round',
          'stroke-linejoin': 'round',
          d: 'M7.5 8.25h9m-9 3h5.25m-8.25 7.5L3 21l3.75-1.5A8.96 8.96 0 003 12a9 9 0 1118 0 9 9 0 01-9 9 8.96 8.96 0 01-4.5-1.2z'
        })
      ]
    )
}
...
const flagTicketSystem = makeSidebarFlag(FeatureFlags.ticketSystem)
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/tickets', label: t('nav.tickets'), icon: SupportIcon, hideInSimpleMode: true, featureFlag: flagTicketSystem },
    ...
    { path: '/shop', label: t('nav.shop'), icon: ShoppingBagIcon, hideInSimpleMode: true },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/tickets', label: t('nav.tickets'), icon: SupportIcon },
    ...
    { path: '/admin/shop', label: t('nav.shop'), icon: ShoppingBagIcon, hideInSimpleMode: true },
