export default {
    accounts: {
      ...
      columns: {
        ...
        upstreamBillingRate: 'Upstream Declared Cost Multiplier',
        weight: 'Weight',
      ...
      upstreamBilling: {
        ...
        autoProbe: 'Automatically probe upstream declared cost multiplier',
        autoProbeHint: 'Refresh the upstream declared cost multiplier on the global interval. This switch alone does not change the account cost multiplier.',
        syncRate: 'Sync upstream declared cost multiplier',
        syncRateHint: 'Update the account cost multiplier after each successful probe, using the base cost multiplier excluding peak hours. Failed probes or declarations outside the allowed range leave it unchanged. Enabling this also turns on "Automatically probe upstream declared cost multiplier".',
        syncRateManagedHint: 'The account cost multiplier is maintained automatically from the upstream declared base cost multiplier (excluding peak hours).',
        syncedRateTooltip: 'This account cost multiplier is synchronized from the upstream declared base cost multiplier (excluding peak hours)',
        manualProbe: 'Probe upstream cost multiplier now',
        stale: 'Stale',
      ...
      bulkEdit: {
        ...
        rateSyncWarning: 'Accounts with upstream cost multiplier sync enabled cannot have their account cost multiplier changed in bulk. Disable sync in the account editor first.',
        rateSyncConflict: 'Cannot change account cost multiplier: {count} target account(s) have upstream cost multiplier sync enabled.',
      ...
      openai: {
        ...
        wsModeConcurrencyHint:
          'When WS mode is enabled, this account\'s concurrency limit becomes the cap of its WS connection pool.',
        wsModeCtxPoolHint:
        ...
        compactModeDesc:
          'Compact mode is the OpenAI Responses API context-compaction feature. Controls how this account participates in /responses/compact routing: Auto follows probe results, Force On always allows it, and Force Off always excludes it.',
      ...
      poolModeRetryDelay: 'Same-Account Retry Delay (ms)',
      poolModeRetryDelayHint:
        'Only applies in pool mode. Default {default}ms, maximum {max}ms. Overrides the default interval when set.',
      ...
      billingRateMultiplier: 'Account Cost Multiplier',
      billingRateMultiplierHint: 'Used for administrator-side account cost, profit statistics, and profit protection; it does not directly affect user charges. 0 means this account cost is calculated as 0.',
      userBillingPricing: {
        title: 'Account-level user pricing (OpenAI API Key only)',
        description: 'Use this when OpenAI API Key accounts in the same pool have different upstream selling prices. The group still schedules the pool; billing follows the account ultimately selected.',
        priorityDescription: 'Base price: an exact account model price match wins; otherwise the existing pricing chain is used. Multiplier: user-specific rate first, then account-level rate, then group rate.',
        multiplierTitle: 'Account-level price multiplier',
        multiplierDescription: 'For accounts whose upstream is another relay with a uniform markup. Per-model complete prices are not required when this is enabled.',
        multiplierLabel: 'Price multiplier',
        multiplierPlaceholder: 'Enter a multiplier, for example 1.2',
        multiplierHint: 'Leave disabled to keep it unset. When enabled, enter a value greater than 0.',
        modelPricingTitle: 'Account-level complete model prices',
        modelPricingDescription: 'Add models individually as needed. Only an exact model-code match overrides the current base price; unconfigured models continue through the existing pricing chain.',
        addModelPricing: 'Add model price',
        noModelPricing: 'No account-level complete model prices configured',
        modelRequired: 'Each account-level model price needs at least one model code',
        combinedWarning: 'Complete prices and the account-level multiplier both apply: a matching complete model price becomes the base, then the account-level multiplier is applied. A user-specific multiplier still has highest priority.',
        multiplierRequired: 'Enter a multiplier greater than 0 after enabling the account-level price multiplier'
      },
      expiresAt: 'Expires At',
