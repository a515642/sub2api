export default {
    ...
    groups: {
      ...
      columns: {
        ...
        id: 'ID',
        platform: 'Platform',
        rateMultiplier: 'User Price Multiplier',
      ...
      rateAndAccounts: '{rate}x user price multiplier · {count} accounts',
      ...
      form: {
        ...
        rateMultiplierLabel: 'User Price Multiplier',
        rateMultiplierHint: 'Multiplier applied to the model base price for user billing; 1.0 = base price, 0.5 = half price, 2.0 = double. This is not the account cost multiplier.',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
        rpmLimitHint: 'Max requests per minute for each user in this group; 0 = unlimited. Once set, it takes over per-user rate limiting in this group (overrides the user-level rpm_limit fallback).',
        firstOutputFailover: 'First-token timeout failover',
        firstOutputFailoverEnabled: 'Enable first-token timeout failover for the OpenAI API Key pool',
        firstOutputFailoverTimeoutLabel: 'First-token timeout (seconds)',
        firstOutputFailoverMaxSwitchesLabel: 'Maximum account switches',
        firstOutputFailoverHint: 'Applies only to streaming requests using an OpenAI API Key pool. If no valid first token arrives in time, another account is tried; the final attempt waits normally.',
      ...
      rateMultiplierHint: 'User billing multiplier: base model cost × effective multiplier. Account cost multiplier is configured separately.',
      ...
      nameRequired: 'Please enter group name',
        rateMultipliers: 'User Price Multipliers',
        rateMultipliersTitle: 'User Price Multiplier Management',
        addUserRate: 'Add User Price Multiplier',
      ...
      modelPricing: {
        title: 'Per-model group pricing',
         description: 'Configures model base-price overrides. Matching entries take precedence over channel and default prices. User billing also applies the effective user multiplier and any applicable service-tier or time factors. Long-context intervals come from channel or official presets.',
         longContext: 'Enable long-context price tiers',
         longContextHint: 'When enabled, select a channel interval or official price tier by context size; otherwise the base tier is normally used. Interval prices already include the tier difference and are not multiplied again.',
        add: 'Add model price'
      },
      voicePricing: {
